...
class MPHCPNetDataset(Dataset):
    def __init__(self,
        ...
        self.hcdt_drug_disease   = hcdt_drug_disease
    ...
    def __getitem__(self, idx):
        ...
        dd_mask    = torch.from_numpy(self.hcdt_drug_disease[di])
        ...
        if self.cell_mut is not None:
            ...
            return drug_fp, cell_expr, dg_mask, dd_mask, dp_mask, neg_mask, cell_mut, y

        return drug_fp, cell_expr, dg_mask, dd_mask, dp_mask, neg_mask, y
